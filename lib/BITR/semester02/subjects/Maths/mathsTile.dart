...
class mathsTileTwo extends StatelessWidget {
  final mathsClassTwo chapters;
  const mathsTileTwo({Key? key,required this.chapters}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        onTap: () {
          if(chapters.id=='01'){
            Navigator.pushNamed(context, '/databaseMathsTwo');
          }
        },
