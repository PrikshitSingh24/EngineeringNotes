...
class database4Maths extends StatefulWidget {

  database4Maths({Key? key}) : super(key: key);

  @override
  State<database4Maths> createState() => _databaseMathsState();
}

class _databaseMathsState extends State<database4Maths> {
  Uint8List? _documentBytes;

  String path =
      'https://firebasestorage.googleapis.com/v0/b/notess-259ea.appspot.com/o/CSE_BITR_SEMESTER01%2FUnit%20-%205%20Matrices%20%20Notes.pdf?alt=media&token=b231bace-e336-47a8-812b-c03dc20d1a8f';
